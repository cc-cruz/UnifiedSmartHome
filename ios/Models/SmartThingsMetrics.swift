...
public class SmartThingsMetrics {
    ...
    func recordError(_ error: SmartThingsError) {
        queue.async {
    ...
    func getErrorCounts() -> [SmartThingsError: Int] {
        queue.sync { errorCounts }
    }
    
    // MARK: - Device Operation Metrics
    
    func recordDeviceOperation(deviceId: String, operation: String, status: String) {
        queue.async {
    ...
    func getDeviceOperationCounts() -> [String: [String: Int]] {
        queue.sync { deviceOperationCounts }
    }
    
    // MARK: - Scene Operation Metrics
    
    func recordSceneOperation(sceneId: String, operation: String, status: String) {
        queue.async {
    ...
    func getSceneOperationCounts() -> [String: [String: Int]] {
    ...
    func recordOperationLatency(_ operation: String, latency: TimeInterval) {
        queue.async {
    ...
    func getOperationLatencies() -> [String: [TimeInterval]] {
